...
/**
 * Generate {@link VueComponentFactory} from the user {@link IsVueComponent} classes annotated by
 * {@link Component}.
 *
 * @author Adrien Baron
 */
public class VueComponentFactoryGenerator extends AbstractVueComponentFactoryGenerator {
  ...
  /**
   * Register components passed to the annotation. The parameters of the generated method are the
   * factories for the local components we depend on. Their values are either injected, or pass
   * directly when using the "get()" static accessor.
   *
   * @param component The Component we generate for
   ...
   * @param staticInitParameters The list of static parameters to pass when calling the init method
  ...
  /**
   * Process the {@link CustomizeOptions} from the {@link Component} annotation. An instance of this
   * class should be created with our factory and used to customize our {@link VueComponentOptions}
   * before passing them to Vue.
   *
